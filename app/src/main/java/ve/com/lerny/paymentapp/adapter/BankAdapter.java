...
public class BankAdapter extends ArrayAdapter<BankResponse>{

    private final Context context;
    private final List<BankResponse> values;

    public BankAdapter(Context context, List<BankResponse> values) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        BankResponse item = values.get(position);
